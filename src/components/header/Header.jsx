        ...
        <header className="col-start-2 col-span-10 mt-5 p-5 bg-white border rounded-lg hidden md:block">
            <div className="flex justify-between">
                ...
                <div className="flex gap-5">
                    ...
                    <button className={`${headerType=="notHome"?"":hidden} p-2 bg-[#FF5A5F] text-white border rounded-lg hover:border-[#FF5A5F] hover:bg-white hover:text-[#FF5A5F]`}>Sign out</button>
                </div>
            </div>
        </header>
    )
